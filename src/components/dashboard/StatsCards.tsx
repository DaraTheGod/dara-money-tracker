...
const StatsCards = () => {
  ...
  return (
    <div className="grid gap-6 md:grid-cols-3">
      <Card className="bg-gray-800/80 dark:bg-gray-800/80 backdrop-blur-sm border border-gray-700 dark:border-gray-700 shadow-lg hover:shadow-xl transition-all duration-300">
